...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'prefectural_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'prefectural_id' => ['type' => 'index', 'columns' => ['prefectural_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-02 15:25:03',
                'modified' => '2019-09-02 15:25:03'
            ],
        ];
        parent::init();
    }
